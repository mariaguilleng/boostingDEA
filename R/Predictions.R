...
#'
#' @description This function predicts the expected output by a \code{MARS} object.
#'
...
#' @param newdata \code{data.frame}. Set of input variables to predict on.
#' @param x Inputs index.
#' @param class Model for prediction. \code{1} MARS Boost without smoothing.\code{2} MARS Boost with smoothing.
#'
#' @return \code{data.frame} with the predicted values.
#'
#' @export
